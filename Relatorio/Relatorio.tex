...
\textit{PSP} realmente tinha medidas de proteção contra a pirataria, como a encriptação do código do jogo e a verificação de assinaturas digitais.
...
Olhando em certo aspecto, o erro dos tribuinais alemães em não terem encaminhado o caso para o TJUE com base na Diretiva 2001/29/CE 
pode ter sido um fator decisivo para a vitória da \textit{Datel}. Sendo assim, a decisão final do TJUE foi correta, mas poderia ter sido diferente se a \textit{Sony} 
tivesse adotado uma abordagem diferente desde o início do processo judicial.
